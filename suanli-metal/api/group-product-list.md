...
> 远端最后更新：2026-08-06T07:39:03.000Z
> 端点：`POST /api/output/v2/device-output/page_list_product_network_v2`
...
- `gpu_models` `array`：卡型集合
  - **array<string>**
- `device_count` `integer` **(必填)**：设备数量
- `network_type` `string` **(必填)**：网络类型，枚举: `Ib`/`Roce`/`NVLinkSwitch`/`EthernetFast`
...
- `data` `array` **(必填)**
  - **array<object>**
    ...
    - `zone_name` `string`：设备区域名称
    - `idc_name` `string`：设备机房名称
